document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Notificações de compra
    const names = ['Renata', 'Cristiane', 'Priscila', 'Juliana', 'Fernanda', 'Amanda', 'Mariana', 'Beatriz', 'Camila', 'Larissa', 'Suelen', 'Gisele', 'Bruna', 'Tatiane'];
        ...
        sealContainer.innerHTML = `
            <div class="relative w-48 h-48 md:w-64 md:h-64 flex items-center justify-center">
                <svg viewBox="0 0 200 200" class="w-full h-full drop-shadow-2xl animate-float">
                    ...
                    <circle cx="100" cy="100" r="75" fill="#7c3aed" />
                    ...
                    <text x="100" y="125" text-anchor="middle" fill="white" font-size="20" font-weight="bold">Dias</text>
                    <rect x="55" y="135" width="90" height="2" fill="rgba(255,255,255,0.4)" />
                    <text x="100" y="152" text-anchor="middle" fill="white" font-size="11" font-weight="bold">Incondicionais</text>
                </svg>
            </div>
        `;
    }
